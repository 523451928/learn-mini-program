  ...
  <div class="mp-container">
    <el-container>
      <el-aside width="138px" class="sup-el-aside">
        ...
        <left-menu v-show="leftMenuVisible" defaultIndex="2" :permissions="permissions"></left-menu>
      </el-aside>
...
export default {
  ...
  methods: {
    ...mapMutations([
      'changeSettingName', 'setFacadeType', 'setShopInfo'
    ]),
    changeStore(item) {
    ...
    getStoreInfo() {
      ...
      this.$http.get(`/api/store/details/${storeId}`).then((res) => {
        ...
        this.setFacadeType(this.shopInfo.facadeType)
  ...
  watch: {
    '$route'(newRouter) {
      if (newRouter.name == 'productrenovation') {
